...
import com.sunmi.print.MApplication
/**
...
object ToastHelper {
    ...
    fun showToast(text: String) {
        showToastInner(MApplication.getApplication(), text, Toast.LENGTH_SHORT)
    }

    fun showToast(resId: Int) {
        showToastInner(MApplication.getApplication(), MApplication.getApplication().getString(resId), Toast.LENGTH_SHORT)
    }
