...
import com.sunmi.print.databinding.ActivityLoginBinding

import com.sunmi.print.ui.PreHomeActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        password.apply {
            ...
            login.setOnClickListener {
                if (!NetTools.canNetworking(this@LoginActivity)){
                    Toast.makeText(this@LoginActivity, "Please connect to the network.", Toast.LENGTH_SHORT).show()
